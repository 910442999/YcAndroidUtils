...
public class YcAppUtils {
    private YcAppUtils() {
        throw new UnsupportedOperationException("u can't instantiate YcAppUtils...");
    }
    ...
    public static void installApp(Context context, String filePath) {
        context.startActivity(YcIntentUtils.getInstallAppIntent(context, filePath));
    }
    ...
    public static void installApp(Context context, File file) {
        if (!YcFileUtils.isFileExists(file))
            return;
    ...
    public static void installApp(Activity activity, String filePath, int requestCode) {
        activity.startActivityForResult(YcIntentUtils.getInstallAppIntent(activity, filePath), requestCode);
    }
    ...
    public static boolean installAppSilent(Context context, String filePath) {
        File file = YcFileUtils.getFileByPath(filePath);
        if (!YcFileUtils.isFileExists(file))
            return false;
        String command = "LD_LIBRARY_PATH=/vendor/lib:/system/lib pm install " + filePath;
        YcShellUtils.CommandResult commandResult = YcShellUtils.execCmd(command, !isSystemApp(context), true);
    ...
    public static boolean isSystemApp(Context context, String packageName) {
        if (YcStringUtils.isEmpty(packageName))
            return false;
        try {
    ...
    public static void uninstallApp(Context context, String packageName) {
        if (YcStringUtils.isEmpty(packageName))
            return;
        context.startActivity(YcIntentUtils.getUninstallAppIntent(packageName));
    }
    ...
    public static void uninstallApp(Activity activity, String packageName, int requestCode) {
        if (YcStringUtils.isEmpty(packageName))
            return;
        activity.startActivityForResult(YcIntentUtils.getUninstallAppIntent(packageName), requestCode);
    }
    ...
    public static boolean isAppRoot() {
        YcShellUtils.CommandResult result = YcShellUtils.execCmd("echo root", true);
        if (result.result == 0) {
            return true;
        }
    ...
    public static void launchApp(Context context, String packageName) {
        if (YcStringUtils.isEmpty(packageName))
            return;
        context.startActivity(YcIntentUtils.getLaunchAppIntent(context, packageName));
    }
    ...
    public static void launchApp(Activity activity, String packageName, int requestCode) {
        if (YcStringUtils.isEmpty(packageName))
            return;
        activity.startActivityForResult(YcIntentUtils.getLaunchAppIntent(activity, packageName), requestCode);
    }
    ...
    public static void getAppDetailsSettings(Context context, String packageName) {
        if (YcStringUtils.isEmpty(packageName))
            return;
        context.startActivity(YcIntentUtils.getAppDetailsSettingsIntent(packageName));
    }
    ...
    public static String getAppSignatureSHA1(Context context, String packageName) {
        ...
        if (signature == null)
            return null;
        return YcEncryptUtils.encryptSHA1ToString(signature[0].toByteArray()).
    ...
    public static boolean isAppForeground(Context context, String packageName) {
        return !YcStringUtils.isEmpty(packageName) && packageName.equals(YcProcessUtils.getForegroundProcessName(context));
    }
    //----------------------------------------------------------------------------------------------------------------
    ...
    public static boolean isInstallApp(Context context, String packageName) {
        return !YcStringUtils.isEmpty(packageName) && YcIntentUtils.getLaunchAppIntent(context, packageName) != null;
    }
    ...
    public static boolean cleanAppData(Context context, File... dirs) {
        boolean isSuccess = YcFileUtils.cleanInternalCache(context);
        isSuccess &= YcFileUtils.cleanInternalDbs(context);
        isSuccess &= YcFileUtils.cleanInternalSP(context);
        isSuccess &= YcFileUtils.cleanInternalFiles(context);
        isSuccess &= YcFileUtils.cleanExternalCache(context);
        for (File dir : dirs) {
            isSuccess &= YcFileUtils.cleanCustomCache(dir);
        }
        return isSuccess;
    }
